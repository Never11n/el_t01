...
def bookstore(request):
    ...
    if request.method == 'POST':
        ...
        #f_adress: m_adress
        args['reg_adress'] = request.POST.get('f_adress', '').replace(' ', '').lower()
        ...
        try:
            ...
            profile.city = args['reg_adress']
            profile.street = args['reg_adress']
            profile.apartments = args['reg_adress']
            profile.save()
        ...
        return render(request, '004/book.html')