...
from el_t01_app.models import (Profile, Ticket_history, Game_history, Ticket_type,
...
from el_t01_app.bot_mess.message_send import message_send
...
def cab_game_play(request, verbal=None):
    ...
    if not args['logged_in'] and not b_gift:
        ...
        #args['main_tab'] = f"{args['GL_MainSkin']}/cabinet/cabinet.html"
        args['main_tab'] = '/home/sod/sod/el_t01/el_t01/templates/001/game.html'
        return render(request, '001/game.html', args)
...
def cab_cartpage(request, img_id):
    print ("==cartpage==")
    args = get_main_args(request, section="main")
    print ("args['lang'] = ", args['lang'])
